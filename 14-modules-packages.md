# فصل چهاردهم: ماژول‌ها، پکیج‌ها و شیءگرایی
...
├── models.py            # @dataclass User, Product, Order  (فصل ۱۱)
├── exceptions.py        # سلسله‌مراتبِ ShopError  (فصل ۱۲)
...
**در فصل بعد:** به آخرین فصلِ مفهومی می‌رویم: **Performance و بهینه‌سازیِ پیشرفته** — تکنیک‌هایی برای اینکه کدِ شیءگرای شما نه‌فقط تمیز، بلکه سریع هم باشد.
