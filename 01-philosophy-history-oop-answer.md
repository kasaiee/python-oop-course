...
> پاسخ‌ها به‌ترتیب پرسش‌های فایل `01-philosophy-history-oop-exercise.md`. هدف، پوشش کامل مطالب فصل است.
...
- هر دو **قراردادمحور**اند نه اجبارمحور؛ به بلوغ برنامه‌نویس تکیه می‌کنند به‌جای قفل اجباری.
